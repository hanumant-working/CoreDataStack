...
//  CoreDataStack.swift
//
//  Created by Hanumant S on 22/07/18.
...
class CoreDataStack {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        var modelURL = Bundle.main.url(forResource: "AppName", withExtension: "momd")
        if !(modelURL != nil) {
           let path =  Bundle.main.url(forResource: "AppName", withExtension: "mom")
            modelURL = path!
        }
        assert(modelURL != nil , "Unable to find resource in main bundle")
